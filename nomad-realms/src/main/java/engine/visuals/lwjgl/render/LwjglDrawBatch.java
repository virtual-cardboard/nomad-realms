...
public class LwjglDrawBatch implements DrawBatch {
	...
	public LwjglDrawBatch vao(VertexArrayObject vao) {
		this.vao = vao;
		return this;
	}

	public LwjglDrawBatch shaderProgram(ShaderProgram shaderProgram) {
		this.shaderProgram = shaderProgram;
		return this;
	}

	public LwjglDrawBatch glContext(GLContext glContext) {
