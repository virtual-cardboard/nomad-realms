...
import static nomadrealms.context.game.card.GameCard.CLAW_FLURRY;
...
public enum BeginnerDecks {
	...
	PUNCH_AND_GRAPPLE("Punch & Grapple", new DeckList(CLAW_FLURRY, INVINCIBILITY, ATTACK, HEAL, MELEE_ATTACK, FREEZE, LIGHTNING_ZAP)),
